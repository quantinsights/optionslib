...
class TestSchedule(unittest.TestCase):
    ...
    def test_both(self):
        ...
        s0 = SchedulePeriod(dt.date(2023,3,15),dt.date(2023,3,20),dt.date(2023,3,15),dt.date(2023,3,20))
        s1 = SchedulePeriod(dt.date(2023,3,20),dt.date(2023,6,20),dt.date(2023,3,20),dt.date(2023,6,20))
        s2 = SchedulePeriod(dt.date(2023,6,20),dt.date(2023,9,20),dt.date(2023,6,20),dt.date(2023,9,20))
        s3 = SchedulePeriod(dt.date(2023,9,20),dt.date(2023,12,20),dt.date(2023,9,20),dt.date(2023,12,20))
        s4 = SchedulePeriod(dt.date(2023, 12, 20), dt.date(2024, 1, 1), dt.date(2023, 12, 20), dt.date(2024, 1, 2))

        self.assertEqual(
            s.get_period(0) == s0,
            True,
            "Failed BOTH stub unit test!"
        )
    ...
    def test_day29_roll_convention(self):
        ...
        s0 = SchedulePeriod(dt.date(2023,1,1),dt.date(2023,1,29),dt.date(2023,1,3),dt.date(2023,1,30))
        s1 = SchedulePeriod(dt.date(2023,1,29),dt.date(2023,2,28),dt.date(2023,1,30),dt.date(2023,2,28))
        s2 = SchedulePeriod(dt.date(2023,2,28),dt.date(2023,3,29),dt.date(2023,2,28),dt.date(2023,3,29))
        s3 = SchedulePeriod(dt.date(2023,3,29),dt.date(2023,4,1),dt.date(2023,3,29),dt.date(2023,4,3))
